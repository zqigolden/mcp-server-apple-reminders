    ...
    prompts: [
      ...
      },
      {
        ...
        arguments: [
          {
            name: "review_type",
            description: "Type of review to perform (overdue, completed, upcoming, all)",
            required: false
          },
          {
            name: "list_name",
        ...
        arguments: [
          {
            ...
            description: "Strategy for cleanup (archive_completed, delete_old, reorganize_lists, merge_duplicates)",
            required: false
          }
        ]
      },
      {
        ...
        arguments: [
          {
            name: "goal_type",
            description: "Type of goal to track (habit, project, learning, health, financial)",
            required: true
          },
          {
            name: "time_horizon",
      ...
      },
      {
        ...
        arguments: [
          {
            name: "task_type",
            description: "Type of task to schedule (meeting, deadline, habit, follow_up, creative_work)",
            required: true
          },
          {
  ...
  server.setRequestHandler(GetPromptRequestSchema, async (request) => {
    ...
    switch (name) {
      case "daily-task-organizer":
        ...
        return {
          description: "Comprehensive daily task organization workflow for Apple Reminders",
          messages: [
            {
              role: "user",
              content: {
      ...
      case "context-aware-scheduling":
        ...
        return {
          description: "Create intelligently scheduled reminders based on context and optimal timing",
          messages: [
            {
              role: "user",
              content: {
